...
function Navigation({
  ...
  const mobileSliderAndDropDownsFormatting =
    "flex flex-row flex-wrap items-center space-x-4 space-y-0";
  const desktopSliderAndDropDownsFormatting =
    "flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4";
  const sliderAndDropDowns = (
    <div
      className={
        isMobile
          ? mobileSliderAndDropDownsFormatting
          : desktopSliderAndDropDownsFormatting
      }
    >
  ...
  const desktop1 = "flex items-center justify-between px-4 py-2";
  const mobile1 = "flex items-center justify-between px-4 py-1";
  return (
    <>
      <nav className="bg-white shadow w-full">
        <div className={isMobile ? mobile1 : desktop1}>
          ...
          {showSearchBar && (
            <div className="flex-1 flex items-center justify-center space-x-4 mx-0">
